  ...
  <div>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <a-button type="primary" v-auth="'warehouse:wms_warehouses:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls">
          导出</a-button
        >
        <j-upload-button type="primary" v-auth="'warehouse:wms_warehouses:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls"
          >导入</j-upload-button
        >
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'warehouse:wms_warehouses:deleteBatch'"
            >批量操作
    ...
    <!-- 表单区域 -->
    <WmsWarehousesModal @register="registerModal" @success="handleSuccess" />
  </div>
</template>
